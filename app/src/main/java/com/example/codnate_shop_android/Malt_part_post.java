...
public class Malt_part_post {
    ...
    public void textPost(PrintStream printStream, String tag, float text, String boundary){
        printStream.print("--" + boundary);
        printStream.print(ENTER_STRING);
        printStream.print("Content-Disposition: form-data; name=\""+tag+"\"");
        printStream.print(ENTER_STRING);
    ...
    public void textPost(PrintStream printStream, String tag, double text, String boundary){
        printStream.print("--" + boundary);
        printStream.print(ENTER_STRING);
        printStream.print("Content-Disposition: form-data; name=\""+tag+"\"");
        printStream.print(ENTER_STRING);
